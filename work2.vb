...
Public Class Form1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim savePath = Path.Combine(Application.StartupPath, "지역별금액.xlsx")
        Using package As New ExcelPackage()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim savePath = Path.Combine(Application.StartupPath, "지역별품목수량.xlsx")
        Using package As New ExcelPackage()
            Using origin = New ExcelPackage(New FileInfo(filePath))
                For Each s In origin.Workbook.Worksheets
                    Dim 지역명 = s.Cells("B4").Text.Trim()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Dim savePath = Path.Combine(Application.StartupPath, "지역별품목금액.xlsx")
        Using package As New ExcelPackage()
            Using origin = New ExcelPackage(New FileInfo(filePath))
                For Each s In origin.Workbook.Worksheets
                    Dim 지역명 = s.Cells("B4").Text.Trim()
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Dim savePath = Path.Combine(Application.StartupPath, "통합품목수량.xlsx")
        Using package As New ExcelPackage()
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        Dim savePath = Path.Combine(Application.StartupPath, "통합품목금액.xlsx")
        Using package As New ExcelPackage()
    ...
    Private Function LoadExcelPath() As Boolean
        If String.IsNullOrEmpty(filePath) Then
            filePath = Path.Combine(Application.StartupPath, "주문내역 - 복사본.xlsx")
        End If
